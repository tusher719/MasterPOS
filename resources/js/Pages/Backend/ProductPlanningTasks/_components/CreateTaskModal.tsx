...
const EMPTY_ITEM: TaskItemFormData = {
    product_id: "",
    variant_id: null,
    quantity: "1",
    unit_cost: "",
...
export default function CreateTaskModal({
    ...
    const [items, setItems] = useState<TaskItemFormData[]>([{ ...EMPTY_ITEM }]);
    ...
    function updateItem(
        ...
        setItems((prev) =>
            prev.map((item, i) => {
                ...
                // Auto-fill unit_cost from variant cost_price_override
    ...
    function handleSubmit() {
        ...
        setSubmitting(true);
        router.post(
            route("backend.product-planning-tasks.store"),
            {
                title,
                note,
                due_date: dueDate,
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
            <div className="flex max-h-[90vh] w-full max-w-6xl flex-col rounded-sm bg-white shadow-xl">
                {/* Header */}
                ...
                <div className="flex-1 overflow-y-auto px-5 py-4 space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder="e.g. Prepare stock for Eid collection"
                ...
                <div className="flex justify-end gap-2 border-t border-gray-100 px-5 py-4">
                    <button
                        onClick={onClose}
                        className="rounded-sm border border-gray-200 px-4 py-2 text-sm font-medium text-gray-600 hover:bg-gray-50"
                    >
                        Cancel
                    </button>
                    <button
                        ...
                        disabled={submitting}
                        className="rounded-sm bg-indigo-600 px-4 py-2 text-sm font-medium text-white hover:bg-indigo-700 disabled:opacity-60"
                    >
