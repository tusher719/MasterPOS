...
interface Props {
    partnerId: number;
    assignment: PartnerProductAssignment;
    products: ProductOption[];
    onClose: () => void;
}

export default function EditProductAssignmentModal({
    partnerId,
    assignment,
    products,
    onClose,
}: Props) {
    const [form, setForm] = useState<ProductAssignmentFormData>({
        assignable_id: "",
        effective_from: "",
        effective_to: "",
    ...
    useEffect(() => {
        setForm({
            assignable_id: String(assignment.assignable_id),
            effective_from: assignment.effective_from
                ? assignment.effective_from.slice(0, 10)
                : "",
            effective_to: assignment.effective_to
                ? assignment.effective_to.slice(0, 10)
                : "",
            cost_return_enabled: assignment.cost_return_enabled,
            profit_share_percent: String(
                Number(assignment.profit_share_percent),
            ),
        });
    }, [assignment]);
    ...
    const handleSubmit = () => {
        ...
        router.put(
            route("backend.partners.product-assignments.update", {
                partner: partnerId,
            ...
            },
            {
                ...
                onError: (errors) => {
                    ...
                    toast.error(first ?? "Failed to update assignment.");
                },
            ...
            <div className="w-full max-w-md rounded-lg bg-white shadow-xl">
                ...
                <div className="flex items-center justify-between border-b border-gray-100 px-5 py-4">
                    <div>
                        ...
                        <p className="text-xs text-gray-400">
                            Pending assignments only — approved assignments
                            cannot be edited.
                        </p>
                    </div>
                    <button
                ...
                <div className="space-y-4 px-5 py-4">
                    ...
                    <div className="flex items-center gap-3 rounded-md border border-gray-200 bg-gray-50 px-4 py-3">
                        ...
                        <div>
                            <label
                                htmlFor="cost_return_enabled_edit"
