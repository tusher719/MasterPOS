...
interface PartnerFormData {
    ...
    note: string;
    is_active: boolean;
    [key: string]: string | boolean; // 👈 এই লাইনটা যোগ করুন
}
...
export default function EditPartnerModal({
    ...
    // Populate form from partner prop
    useEffect(() => {
        setForm({
            name: partner.name,
            partner_type_capital: partner.partner_type_capital,
            partner_type_working: partner.partner_type_working,
            partner_type_product: partner.partner_type_product,
            phone: partner.phone ?? "",
            email: partner.email ?? "",
    ...
    const handleSubmit = () => {
        ...
        router.put(
            route("backend.partners.update", { partner: partner.id }),
            form,
            {
                onSuccess: () => {
                ...
                onError: (errs) => {
                    setErrors(
                        errs as Partial<Record<keyof PartnerFormData, string>>,
                    );
