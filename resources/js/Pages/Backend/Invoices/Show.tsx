    ...
    return (
        <AuthenticatedLayout>
            ...
            <div
                ...
                className="mx-auto max-w-3xl rounded-lg border border-gray-200 bg-white p-8 shadow-sm print:shadow-none print:border-none print:rounded-none print:max-w-full print:p-6"
            >
                {/* Header */}
                ...
                <div className="mt-10 border-t border-gray-100 pt-6 text-center">
                    <p className="text-xs text-gray-400">
                        Thank you for your business! — {business.business_name}
                    </p>
                    {business.phone && (
            ...
            <style>{`
                @media print {
                    /* Hide everything outside invoice */
