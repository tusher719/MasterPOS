        ...
        <AuthenticatedLayout>
            ...
            <div className="space-y-4 print:space-y-3">
                ...
                <div className="print:hidden">
                    <ReportFilters
                        filters={filters}
                        routeName="backend.reports.purchases"
                    />
                </div>
                            ...
                            <tbody className="divide-y divide-gray-100">
                                {rows.length === 0 ? (
                                    <tr>
                                        ...
                                        >
                                            No purchases found for the selected
                                            period.
                                        </td>
                                    </tr>
                                ) : (
                                        ...
                                        >
                                            ...
                                            <td className="px-4 py-2.5 text-center">
                                                <span
                                                    ...
                                                    ${ORDER_BADGE[row.purchase_status] ?? "bg-gray-100 text-gray-500"}`}
                                                >
                                                    {orderLabel(
                                                        row.purchase_status,
                                                    )}
                                            ...
                                            <td className="px-4 py-2.5 text-center">
                                                <span
                                                    className={`rounded-full px-2 py-0.5 text-xs font-medium
                                                    ${PAYMENT_BADGE[row.payment_status] ?? "bg-gray-100 text-gray-500"}`}
                                                >
                                                    {row.payment_status
                                                        .charAt(0)
                                                        .toUpperCase() +
