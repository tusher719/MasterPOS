...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .two-col { display: flex; gap: 16px; padding: 0 20px; }
        .col-main { flex: 3; }
        .col-side { flex: 1; }
        ...
        .section-head { background: #f3f4f6; padding: 6px 10px; font-size: 8px; font-weight: 700;
                         color: #6b7280; text-transform: uppercase; letter-spacing: 0.05em;
                         border-bottom: 1px solid #e5e7eb; }
        .cat-row { display: flex; justify-content: space-between; padding: 5px 10px;
                   border-bottom: 1px solid #f3f4f6; font-size: 9px; }
...
<body>
    ...
    <div class="two-col">
        ...
        <div class="col-side">
            <div class="section">
                ...
                @php
                    $byCategory = $rows->groupBy('category_name')
    ...
    <div class="footer">
        <span>{{ config('app.name', 'Master POS') }} — Expense Report ({{ $from }} to {{ $to }})</span>
